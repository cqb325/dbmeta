...
(function($) {
    ...
    function SlickGrid(container,data,columns,options) {
        ...
        function createCssRules() {
            $style = $("<style type='text/css' rel='stylesheet' id='slickstyle'/>").appendTo($("head"));
            ...
            //added by cqb 2011-12-31
            if(!stylesheet){
	            var slickstyle = document.getElementById("slickstyle");
            	stylesheet = slickstyle.sheet;
            }
        }
