...
(function($) {
    ...
    var SlickEditor = {
        ...
        BoolCellFormatter : function(row, cell, value, columnDef, dataContext) {
            return value ? "<img src='"+JSLoader.getLibPath+"plugins/grid/slick/images/tick.png'>" : "";
        },
        ...
        TaskNameFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            return spacer + " <img src='"+JSLoader.getLibPath+"plugins/grid/slick/images/expand.gif'>&nbsp;" + value;
        },
        ...
        ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            if (columnDef.width < 50)
                return (resources.length > 1 ? "<center><img src='"+JSLoader.getLibPath+"plugins/grid/slick/images/user_identity_plus.gif' " : "<center><img src='"+JSLoader.getLibPath+"plugins/grid/slick/images/user_identity.gif' ") +
        ...
        StarFormatter : function(row, cell, value, columnDef, dataContext) {
            return (value) ? "<img src='"+JSLoader.getLibPath+"plugins/grid/slick/images/bullet_star.png' align='absmiddle'>" : "";
        },
        
        codeFormatter: function(row, cell, value, columnDef, dataContext) {
        	var result = (value && value != "") ? (columnDef.formatcode[value] ? columnDef.formatcode[value] : value) : "";
        	return result;
        },
        
		codeEditor: function(args){
			var formatcode = args.column.formatcode;
			var $select = null;
			var defaultValue = null;
			
			
			this.init = function() {
				$select = $("<select>").addClass("cui-grid-select").attr("name",args.column.field);
               	$select.append("<option value=''>请选择</option>");
                for(var i in formatcode){
					$select.append("<option value='"+i+"'>"+formatcode[i]+"</option>");
				}
        ...
        DateCellEditor : function(args) {
            ...
            this.init = function() {
                ...
                $input.datepicker({
                    ...
                    buttonImage: JSLoader.getLibPath+"plugins/grid/slick/images/calendar.gif",
        ...
        StarCellEditor : function(args) {
            ...
            this.init = function() {
                $input = $("<IMG src='"+JSLoader.getLibPath+"plugins/grid/slick/images/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />")
